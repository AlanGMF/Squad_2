...
if st.button('get the data'):
    ...
    res = requests.get(url="http://0.0.0.0:8000/getdata")
    res = res.json()

    dataframe1 = pd.read_csv(str(res[0]))
    st.dataframe(dataframe1)

    dataframe2 = pd.read_csv(str(res[1]))
    st.dataframe(dataframe2)

    dataframe3 = pd.read_csv(str(res[2]))
    st.dataframe(dataframe3)

    dataframe4 = pd.read_csv(str(res[3]))
    st.dataframe(dataframe4)

    dataframe5 = pd.read_csv(str(res[4]))
    st.dataframe(dataframe5)

    dataframe5 = pd.read_csv(str(res[5]))
    st.dataframe(dataframe5)
